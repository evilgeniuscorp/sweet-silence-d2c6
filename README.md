...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/sweet-silence-d2c6)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-silence-d2c6
```

A live public deployment of this template is available at [https://sweet-silence-d2c6.templates.workers.dev](https://sweet-silence-d2c6.templates.workers.dev)
